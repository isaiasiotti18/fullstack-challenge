...
- [ ] Containers Prometheus + Grafana no `docker-compose.yml`
- [ ] `@opentelemetry/sdk-node` em ambos serviços
- [ ] Métricas: `crash_game_rounds_total`, `crash_game_bets_total`, `crash_game_rtp`, `crash_game_ws_latency`
- [ ] Dashboard Grafana pré-configurado
- **Arquivos:** `docker-compose.yml`, `docker/prometheus/`, `docker/grafana/`, pacote shared
